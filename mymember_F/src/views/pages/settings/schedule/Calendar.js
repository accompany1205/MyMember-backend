...
import { Card, CardBody, Button, ButtonGroup, Modal } from "reactstrap"
  ...
  static getDerivedStateFromProps(props, state) {
    if (
      ...
      let dateToObj = props.app.events.map(event => {
        ...
        //event.start = new Date(`${event.end_date}, ${event.end_time}`)
  ...
  render() {
    ...
    return (
      <div className="app-calendar position-relative">
        ...
        {this.props.handleSidebar && <AddEventSidebar
          sidebar={sidebar}
