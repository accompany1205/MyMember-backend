...
import {GET_ACTIVE_TRAIL_LIST} from '../../../../redux/actions/newstudent/index';
...
class UsersList extends React.Component {
  ...
  componentDidMount() {
    ...
    // })
    this.props.GET_ACTIVE_TRAIL_LIST();
  }

  componentDidUpdate(prevProps){
     if(prevProps.active_trail !== this.props.active_trail){
       this.setState({
         rowData : this.props.active_trail,
         loading: false
       })
     }
  }
  ...
  render() {
    ...
    return (
      <Row className="app-user-list">
        ...
        <Col sm="12">
        <Breadcrumbs
          breadCrumbTitle="Active Trail"
          breadCrumbParent="Home"
          breadCrumbActive="Active Trail"
        />
          <Card>
            <CardHeader> 
...
const mapStateToProps = (state) => {
    return {
      active_trail : state.student.active_trail
    }
}

export default connect(mapStateToProps, {GET_ACTIVE_TRAIL_LIST})(UsersList)
