...
router.post('/admin/product/add_product/:adminId/:folderId', upload.single('attach'), isAdmin, create)
...
router.put('/admin/product/update_product/:adminId/:productId', upload.single('attach'), isAdmin, updateproduct)
