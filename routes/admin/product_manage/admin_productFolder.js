...
const { getproductFolder, createproductFolder, updateproductFolder, deleteproductFolder } = require("../../../controllers/productFolder")

router.get("/admin/product/folder_list/:adminId", isAdmin, getproductFolder);
