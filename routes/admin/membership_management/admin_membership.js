...
router.post('/admin/membership/add_membership/:adminId/:folderId', upload.single('membership_profile'), isAdmin, create)
...
router.put('/admin/membership/update_membership/:adminId/:membershipId', upload.single('membership_profile'), isAdmin, membershipUpdate)
