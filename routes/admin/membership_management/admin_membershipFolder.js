...
const { getFolders, create_folder, update_folder, delete_folder } = require("../../../controllers/membershipFolder")

router.get("/admin/membership/folder_list/:adminId", isAdmin, getFolders);
