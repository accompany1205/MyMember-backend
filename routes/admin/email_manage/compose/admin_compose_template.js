...
const { add_template, list_template, remove_template, update_template, multipal_temp_remove, getData, swapAndUpdate_template, isFavorite, allSent, allScheduledListing, sendVerificationMail, criteria_met } = require("../../../../controllers/compose_template");



router.post("/admin/email_compose/add_template/:adminId/:folderId", isAdmin, upload.array('attachments'), add_template)
