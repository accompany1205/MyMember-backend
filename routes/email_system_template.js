...
router.put("/email_system/update_template_status/:userId/:folderId", isAdmin, status_update_template)
router.put("/email_system/single_template_status_change/:userId/:tempId", isAdmin, single_temp_update_status)//single template status change
