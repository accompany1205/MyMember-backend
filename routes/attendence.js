...
const { create, remove, list_attendence, search_std, getStudentAttendence, update, searchAttendance } = require("../controllers/attendence")
...
router.get("/attendence/search/:userId/:page_no/:per_page", verifySchool, searchAttendance)
