...
router.get("/renewal/expire_memebership_std/:userId", verifySchool, expireStd)
router.get("/renewal/expire_membership_std_less_thirty/:userId", verifySchool, expire_thirty_std)
router.get("/renewal/expire_membership_std_less_sixty/:userId", verifySchool, expire_sixty_std)
