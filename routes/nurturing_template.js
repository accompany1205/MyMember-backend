...
const { add_template, list_template, remove_template, status_update_template, update_template, single_tem_update_status, all_email_list, swap_template, multipal_temp_remove } = require("../controllers/nurturing_template")
