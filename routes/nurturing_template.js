...
router.post("/email_nurturing/add_template/:userId/:folderId",verifySchool,add_template) //add Templete

router.put("/email_nurturing/drag_drop_templete/:userId",requireSignin,swapAndUpdate_template)

router.put("/email_nurturing/update_template/:userId/:templateId",verifySchool,update_template) //update Templete
...
router.delete("/email_nurturing/multipal_remove_template/:userId",verifySchool,multipal_temp_remove)
